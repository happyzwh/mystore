...
public class ImageCaptchaServlet extends HttpServlet {
    ...
    private void genernateCaptchaImage(final HttpServletRequest request, final HttpServletResponse response)  
        ...
        try {  
            ...
            CaptchaService instance = (CaptchaService)CaptchaServiceSingleton.getInstance();
            BufferedImage challenge = (BufferedImage)instance.getChallengeForID(captchaId, request.getLocale());
            ...
            redisTemplate.opsForHash().put(Constants.KEY_VERIFYCODE, captchaId, code);  
            redisTemplate.expire(Constants.KEY_VERIFYCODE, Constants.VALUE_TIME_VERIFYCODE, TimeUnit.MINUTES);
